...
function pf(index){
	...
	var params={
		title:"语音作业评分",
		url:"/ZDesk/zh_cn/ZQC/yuyinzuoyepingfen.html?data_source=fushen&id="+getId()[0].id+'&closeFn='+searchData+"&score_state="+getId()[0].score_state+"&grade_name="+getId()[0].grade_name+"&file_name="+getId()[0].file_name+"&file_location="+getId()[0].file_location,
		width:"900"
	};
