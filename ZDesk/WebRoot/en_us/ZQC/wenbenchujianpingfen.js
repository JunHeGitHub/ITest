...
function initData() {
	...
	*/
    ...
    pat.nameSpaceId = 'wenBenZuoYeChuJianPingFen_initData';
...
function searchData(){
	...
	var pat={};	
	pat.nameSpace = 'com.zinglabs.apps.mybaits_xml_def.ZQC';
    pat.nameSpaceId = 'wenBenZuoYeChuJianPingFen_search';
...
function pf(index){
	...
	var params={
		title:"文本作业评分",
		url:"/ZDesk/zh_cn/ZQC/wenbenzuoyepingfen.html?data_source=chujian&id="+dt[index].id+"&closeFn="+searchData+"&score_state="+dt[index].score_state+"&grade_name="+dt[index].grade_name+"&file_name="+dt[index].file_name+"&file_location="+dt[index].file_location,
		width:"900"
	};
