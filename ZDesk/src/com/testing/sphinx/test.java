...
//		}
		...
		String host = "115.28.14.8";
//		int port = 9312;
		int port = 43470;
		int mode = SphinxClient.SPH_MATCH_ALL;
//		String index = "*";
//		String index = "cardUser";
		String index = "addressbook2";
...
//		q.append("@Email *zinglabs  | ");
//		q.append("@Title ccc");
//		q.append("@Title Mr");
		
//		q.append("@FirstName *ma2峰*  | @LastName *ma2峰* | @Title *ma2峰*");
//		q.append("@FirstName *峰天*  | @LastName *峰天* | @Title *峰天*");
//		q.append("zinglabs");
		
		
		q.append("@FirstName 电脑 |");
		q.append("@FirstName 李");
//		q.append("@FirstName 吃饭");
