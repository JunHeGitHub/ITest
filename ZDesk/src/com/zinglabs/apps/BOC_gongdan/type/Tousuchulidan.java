...
////处理分行或者总行
	...
	//投诉类型
	String omplainType_2_ComplainType ;
	//被投诉人
	String defendant_2_ComplainedPerson ;
	//被投诉部门
	String referDept_2_ComplainedDept ;
	
	//所在分行
	String belongBank_2_ComplainedBranch ;
	//投诉内容
	String matter_2_ComplainedContent ;
