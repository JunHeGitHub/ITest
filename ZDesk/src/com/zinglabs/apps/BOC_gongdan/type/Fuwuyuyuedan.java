 ...
 * 服务预约单接口字段
 * */
public class Fuwuyuyuedan {
	
	////处理分行或者总行
	String Branchid_2_Branchid ;
	////处理部门
	...
	//预约内容
	String matter_2_Booking ;
	//预处理时间
	String manageTime_2_PretreatTime ;
	//预处理地点
	String manageSite_2_PretreatSite ;
	//代办人姓名
	String replaceAgent_2_AgentName ;
	//代办人证件号码
	String replaceAgent_2_AgentCertNo ;
	////代办人联系电话
	String AgentPhone_2_AgentPhone ;
	////详细预约说明
	String rBookingRemark_2_BookingRemark ;	
	////处理时限
	String LimitTime_2_LimitTime ;
	////渠道标示
