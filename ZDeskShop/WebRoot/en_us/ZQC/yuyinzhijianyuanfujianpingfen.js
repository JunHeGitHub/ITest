...
function pf(index){
	...
	var params={
		title:"语音作业评分",
		url:"/ZDesk/zh_cn/ZQC/yuyinzuoyepingfen.html?data_source=fujian&id="+dt[index].id+"&closeFn="+searchData+"&score_state="+dt[index].score_state+"&grade_name="+dt[index].grade_name+"&file_name="+dt[index].file_name+"&file_location="+dt[index].file_location,
		width:"900"
	};
