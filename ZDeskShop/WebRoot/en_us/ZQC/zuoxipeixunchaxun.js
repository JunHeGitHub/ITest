...
function pf(index){
    ...
    var u="http://"+dt[index].file_location+"/ZDesk/"+dt[index].file_name;
	var params={
		title:"查看内容",
		width:"700",
		url: "/ZDesk/zh_cn/ZQC/wenbenzuoyepingfen.html?peixun=peixun&grade_id="+dt[index].grade_id+"&lujing="+u 
	...
	var params={
		title:"查看内容",
		width:"700",
		url: "/ZDesk/zh_cn/ZQC/yuyinzuoyepingfen.html?peixun=peixun&grade_id="+dt[index].grade_id+"&lujing="+u
