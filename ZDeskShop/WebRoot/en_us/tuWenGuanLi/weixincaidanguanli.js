 ...
 //@@ 树的展示
		function getItemTree(){
			...
			function doUpdate(){
			    ...
			    var json=eval('('+data+')');
					     if(json.success){*/
							...
							$("#url").val('');
							document.getElementById('isStart1').checked=true;
							document.getElementById('isStart2').checked=false;
							...
							if(data.data!=""&&data.data!=null){
								for(var i=0;i<data.data.length;i++){
								   /*var pat1 = {};
								pat1.tableName = "tree_weixincaidan";
								pat1.primaryKey = "id";
								pat1.primaryKeyValue = data.data[i].id;
								pat1.isStart=0;
							    commonUpdate(pat1,function(data){*/
			...
			document.getElementById('isStart2').checked=true;
			}	
    		}else{
    		    $("#gexiangzhibiaoDiv").hide();	
    		    $("#gexiangzhibiaoDiv_").hide();
