...
document.write("<script language=javascript src='/ZDesk/js/appCommonUtil.js'></script>");
document.write("<script language=javascript src='/ZDesk/js/golbal_params.js'></script>");
document.write("<script language=javascript src='/ZDesk/js/appCommonCurdUtils_new.js'></script>");
document.write("<script language=javascript src='/ZDesk/js/common_utils.js'></script>");*/
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.state == 'SUCCESS') {
                    	    ...
                    	    data_dingyi.imageUrl="/"+window.top.PRJ_PATH+json.url;
                    	    data_dingyi.imagePhysicalPath=json.physicalPath;
                    	    data_dingyi.genusGroup="未分组";
                    	    data_dingyi.uploadPeople=window.top.getUserInfo().loginName;
                    	    data_dingyi.uploadTime=window.top.fomateDate("YYYY-MM-dd hh:mm:ss",new Date());
						    params.columnValues=data_dingyi;
