...
function pf(dt){
	...
	var params={
		...
		url:"/"+window.top.PRJ_PATH+"/zh_cn/ZQC/RS_yuyinzuoyepingfen.html?data_source=fujian&id="+dt.id+"&closeFn="+searchData1+"&score_state="+dt.score_state+"&grade_name="+dt.grade_name+"&file_name="+dt.file_name+"&file_location="+dt.file_location,
		width:"900"
	};
