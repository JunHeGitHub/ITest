...
function pf(dt){
	...
	var params={
		title:"文本作业评分",
		url:"/"+window.top.PRJ_PATH+"/zh_cn/ZQC/wenbenzuoyepingfen.html?data_source=chujian&id="+dt.id+"&closeFn="+searchData+"&score_state="+dt.score_state+"&grade_name="+dt.grade_name+"&file_name="+dt.file_name+"&file_location="+dt.file_location,
		width:"900"
	};
