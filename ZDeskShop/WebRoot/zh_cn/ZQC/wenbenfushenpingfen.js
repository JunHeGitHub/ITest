...
function pf(dt){
	...
	var params={
		title:"文本作业评分",
		url:"/"+window.top.PRJ_PATH+"/zh_cn/ZQC/wenbenzuoyepingfen.html?data_source=fushen&id="+getId()[0].id+'&closeFn='+searchData+"&score_state="+getId()[0].score_state+"&grade_name="+getId()[0].grade_name+"&file_name="+getId()[0].file_name+"&file_location="+getId()[0].file_location,
		width:"900"
	};
