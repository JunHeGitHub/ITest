...
public abstract class HtmlUtils {
	...
	public static void main(String [] args){
		System.out.println(HtmlUtils.htmlEscape("中国人abc123~!@#$%^&*("));
		System.out.println(HtmlUtils.htmlEscapeDecimal("中国人abc123~!@#$%^&*("));
		System.out.println(HtmlUtils.htmlEscapeHex("中国人abc123~!@#$%^&*("));
		System.out.println(HtmlUtils.htmlUnescape("中国人abc123~!@#$%^&*("));
	}
